...
<body class="p-5">
    ...
    <button
        class="mt-5 px-6 py-2 font-medium tracking-wide text-white transition-colors duration-300 transform bg-yellow-600 rounded-lg hover:bg-yellow-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
        <a href="/pokemons/create">Créer un pokemon</a>
    </button>

    <div class="flex flex-wrap justify-center gap-5">
        @foreach ($pokemons as $pokemon)
            <div class="mt-5 w-full max-w-sm px-4 py-3 rounded-md shadow-md bg-purple-900">
